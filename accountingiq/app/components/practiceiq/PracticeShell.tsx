...
const NAV = [
  { href: '/practiceiq', label: 'Dashboard', icon: '🏠' },
  { href: '/practiceiq/clients', label: 'Clients', icon: '👥' },
  { href: '/practiceiq/tasks', label: 'Tasks', icon: '✅' },
  { href: '/practiceiq/tasks/recurring', label: 'Recurring', icon: '🔁' },
  { href: '/practiceiq/calendar', label: 'Calendar', icon: '📅' },
  { href: '/practiceiq/documents', label: 'Documents', icon: '📁' },
  { href: '/practiceiq/invoices', label: 'Invoices', icon: '🧾' },
  { href: '/practiceiq/settings', label: 'Settings', icon: '⚙️' },
];
      ...
      >
        ...
        >
          ...
          <div className="flex gap-3">
            <Link href="/portal" style={{ color: 'var(--text2)' }}>← Portal</Link>
