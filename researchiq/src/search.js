...
async function searchCases(query, options = {}) {
    const {
        ...
        advanceSearch = { anyOfSearch: '', exactSearch: '', notIncludeSearch: '' },
        isAdvSearch = false
    } = options;
        ...
        if (response.data && response.data.Data) {
            ...
            return {
                results: results.map(r => ({
                    ...
                    citation: r.heading2 || r.citation || '',
                    court: r.courtName || r.court || '',
                    date: r.heading4 || r.date || r.decisionDate || '',  // heading4 = clean date e.g. "08-03-2022"
                    shortContent: r.shortContent || r.summary || r.headnote || '',
